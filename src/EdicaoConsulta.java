 ...
 * @author Eugenio
 */
public class EdicaoConsulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Actualizar dados das consultas");
        ...
        jLabel4.setBounds(320, 220, 110, 50);
        ...
        jTextField6.setBounds(300, 270, 149, 30);

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 102, 255));
        jLabel7.setText("Tipo de consulta:");
        jDesktopPane1.add(jLabel7);
        jLabel7.setBounds(110, 217, 190, 50);
        ...
        jLabel12.setBounds(60, 170, 60, 50);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(51, 102, 255));
        jLabel2.setText("Cod_consul:");
        jDesktopPane1.add(jLabel2);
        jLabel2.setBounds(0, 90, 130, 50);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(51, 102, 255));
        jLabel8.setText("Pesquise o Cod_consulta:");
        jDesktopPane1.add(jLabel8);
        jLabel8.setBounds(30, 60, 250, 50);
        ...
        jComboBox1.setBounds(110, 270, 140, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int cod_consulta = Integer.parseInt(jTextField8.getText());
        ...
        marc.setCod_consulta(cod_consulta);
        marc.setNome(Nome);
        marc.setHora(Hora);
        marc.setDia(Dia);
        marc.setMes(Mes);
        marc.setAno(ano);
        marc.setTipo_consulta(tipo);
        
        marc.setTelefone(telefone);
       

        MarcacaoDao caddao = new MarcacaoDao();
        caddao.editar(marc);
        jTextField8.setText("");
        jTextField1.setText("");
        jTextField2.setText("");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Marcaca marc = dao.getPesquisa(idPesquisa);
        ...
        jTextField8.setText(String.valueOf(marc.getCod_consulta()));       
        jTextField1.setText(marc.getNome());
        jTextField2.setText(marc.getHora());   
        jTextField3.setText(String.valueOf(marc.getDia()));
        jComboBox3.setSelectedItem(marc.getMes());       
        jTextField5.setText(String.valueOf(marc.getAno()));  
        jComboBox1.setSelectedItem(marc.getTipo_consulta());          
        jTextField6.setText(String.valueOf(marc.getTelefone()));             
